    ...
    <div class="collapse" :id="'Day' + day.dayId + 'Collapse'">
        ...
        <div :id="'Day' + day.dayId + 'EndLocation'"> 
            <div class="input-group w-50 mb-3">
                ...
                <input type="text" @input="findPlace" class="form-control" placeholder="Add a place" :aria-describedby="'Day' + day.dayId + 'location'">
                <div class="dropend">
                    <button type="button" class="btn btn-sm btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">More</button>
